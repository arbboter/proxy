...
/*
	MAX_CHANNELS默认给的是64个声道, 占用10M左右内存
	双声道占用339K左右, 修改为linux只需要双声道, Windows预留4声道
	[2013-07-19 L]
*/
#ifndef WIN32
...
#else
# define FRAME_LEN 1024
# define BLOCK_LEN_LONG 1024//1024
# define BLOCK_LEN_SHORT 128//128
#endif

#define NSFB_LONG  51//41
...
#define TNS_MAX_ORDER 7//for main  ,12for else ;longwindow, 7 for all profiles ;shortwindow
