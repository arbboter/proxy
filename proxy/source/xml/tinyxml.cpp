...
//int fprintf(char *&deststr, const char * strformat, ...)
//{
//	va_list argList;
//	va_start(argList, strformat);
//	try
//	{
//		vsprintf(deststr, strformat, argList);
//	}
//	catch(...)
//	{
//		deststr[0] = '\0';
...
bool TiXmlDocument::LoadXML(const char *buf, TiXmlEncoding encoding)
{
	if ( !buf ) 
	{
		assert(false);
...
bool TiXmlDocument::ToXmlString(char *xmlString)
{
	return true;
}
...
{
	DoIndent();
	declaration.Print( (FILE *)0, 0, &buffer );
	DoLineBreak();
	return true;
}
